#ifndef MyAnalysis_xAODBaselineAnalysis_H
#define MyAnalysis_xAODBaselineAnalysis_H
...
class xAODBaselineAnalysis : public EL::Algorithm
{
...
public:
  ...
  ClassDef(xAODBaselineAnalysis, 1);
};
