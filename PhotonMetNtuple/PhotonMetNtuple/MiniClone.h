...
public:
  ...
  vector<float>   *ph_noniso_etcone40;
  ...
  Float_t         dphi_gamjet;
  Float_t         dphi_jetmet;
  Float_t         dphi_jet1met;
  Float_t         dphi_gammet;
  Float_t         dphi_met_trackmet;
  ...
  vector<float>   *new_ph_noniso_etcone40;
  ...
  Float_t         new_dphi_jet1met;   
  Float_t         new_dphi_met_trackmet;
