...
def run_job(sample, driver):
    ...
    if driver == 'grid':
        ...
        driver.options().setString(ROOT.EL.Job.optGridExcludedSite, 'ND ANALY_NSC,US ANALY_BNL_SHORT,US ANALY_BNL_LONG,US ANALY_MWT2_SL6,US ANALY_HU_ATLAS_Tier2,CA ANALY_SFU')
...
def main():
    ...
    #grl = '/afs/cern.ch/user/a/atlasdqm/grlgen/All_Good/data15_13TeV.periodAllYear_DetStatus-v69-pro19-03_DQDefects-00-01-02_PHYS_StandardGRL_All_Good_25ns.xml'
    ...
    if args.grid:
        ...
        run_job('/raid/falonso/SUSY1/mc_multijet', 'local')
        
    elif args.testdata:
        args.output = 'output_data'
        run_job('/raid/falonso/SUSY1/data', 'local')
        #run_job('/raid/falonso/mini2/25ns/v13/data15_13TeV', 'local')
        #run_job('/raid/falonso/mini2/dataj', 'local')
